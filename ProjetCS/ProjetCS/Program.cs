...
while (running)
{
    ...
    switch (choice)
    {
        ...
        case var s when s.Contains("Find a customer by his identifier"):
            ...
            customerElement = customerRepository.GetCustomerById(Guid.Parse(Console.ReadLine()));
        ...
        case var s when s.Contains("Find a vehicle by his identifier"):
            ...
            vehicleElement = vehicleRepository.GetVehicleById(Guid.Parse(Console.ReadLine()));
